...
test.describe('Search Bar Query Normalization - Unit Tests', () => {
    test.beforeEach(async ({ page }) => {
        ...
        // Inject the script content safely using path resolution
    ...
    test('handles special characters without crashing', async ({ page }) => {
        ...
        // We just ensure it doesn't crash and returns an array.
        // As no special character queries exist in mock data, it should return an empty array.
