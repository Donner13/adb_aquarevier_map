...
const GLOSSAR_BEGRIFFE = {
  ...
  BETREIBER: "Das Unternehmen oder die Organisation, die eine Anlage (z.B. Kläranlage, Stauanlage) betreibt und für deren Funktion verantwortlich ist.",
  GEWAESSER_EINLEITUNG: "Das Gewässer (Fluss, See, Bach), in das Abwasser oder gereinigtes Wasser eingeleitet wird.",
  PEGEL: "Eine Messstelle an einem Gewässer, die den Wasserstand und/oder den Abfluss kontinuierlich erfasst.",
  STAUANLAGE: "Ein Bauwerk in einem Gewässer (z.B. Wehr, Damm), das dazu dient, den Wasserstand zu regulieren, Wasser zu speichern oder Energie zu gewinnen.",
  QUERBAUWERK: "Ein Bauwerk, das quer zur Fließrichtung eines Gewässers errichtet ist und den Abfluss beeinflusst, z.B. Wehre, Sohlgleiten oder Abstürze.",
  REGENBECKEN: "Ein Bauwerk in der Kanalisation, das bei starkem Regen überschüssiges Misch- oder Regenwasser zwischenspeichert, um die Kläranlage zu entlasten und Gewässer vor Überlauf zu schützen.",
  GRUNDWASSERMESSSTELLE: "Eine Einrichtung zur Beobachtung des Grundwassers, z.B. zur Messung des Grundwasserstands oder zur Entnahme von Proben für Qualitätsanalysen.",
  EINZUGSGEBIET: "Das gesamte Landgebiet, aus dem Wasser (z.B. Regenwasser) in ein bestimmtes Gewässer oder Gewässersystem abfließt."
};
