...
IN_PATH = os.path.join(BASE, "stauanlagen.json")
OUT_PATH = os.path.join(BASE, "stauanlagen.geojson")
ROOT_COPY_PATH = os.path.join(ROOT_PATH, "stauanlagen.geojson")
ROOT_COPY_PATH = os.path.join(ROOT_PATH, "stauanlagen.geojson")
ROOT_COPY_PATH = os.path.join(ROOT_PATH, "stauanlagen.geojson")
ROOT_PATH = os.path.join(BASE, "..")
...
def main():
    ...
    # Write changelog
    write_changelog("stauanlagen", "anlagen_nr", old_features, features, os.path.join(ROOT_PATH, "changelog"))
