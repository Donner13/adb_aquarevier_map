...
(function() {
    window.openAiAssistantModal = function() {
        ...
        modal.innerHTML = `
            <div style="background: var(--bg-surface, #ffffff); width: 100%; max-width: 540px; border-radius: 12px; box-shadow: var(--modal-shadow, 0 10px 30px rgba(0, 0, 0, 0.5)); overflow: hidden; display: flex; flex-direction: column; max-height: 80vh; font-size: 12px;">
                ...
                <div style="padding: 16px; flex: 1; overflow-y: auto;">
                    <div style="font-size: 11px; color: var(--text-secondary, #64748b); margin-bottom: 12px;">
    ...
    window.askAiQuestion = function(question) {
        ...
        box.innerHTML = `<div style="color: var(--text-secondary, #64748b); text-align: center;">🤖 Analysiere Geo-Datenbank...</div>`;
