...
(function() {
    ...
    window.toggleDarkMode = function() {
        ...
        if (window.isDarkMode) {
            ...
            window.AppStorage.setItem('theme', 'dark');
            window.AppStorage.setItem('aquarevier_theme', 'dark');
        } else {
            body.classList.remove('dark-theme');
            body.classList.add('light-theme');
            window.AppStorage.setItem('theme', 'light');
            window.AppStorage.setItem('aquarevier_theme', 'light');
        }
    ...
    function initTheme() {
        const savedTheme = window.AppStorage.getItem('theme') || window.AppStorage.getItem('aquarevier_theme');
