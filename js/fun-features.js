...
(function(window) {
    ...
    class AquaFunSuite {
        constructor() {
            this.achievements = JSON.parse(window.StorageModule.getItem('aquarevier_achievements') || '{}');
            this.visitedDistricts = new Set(JSON.parse(window.StorageModule.getItem('aquarevier_visited_districts') || '[]'));
            this.clickedStationsCount = parseInt(window.StorageModule.getItem('aquarevier_clicked_stations') || '0', 10);
        ...
        unlockAchievement(id, title) {
            ...
            window.StorageModule.setItem('aquarevier_achievements', JSON.stringify(this.achievements));
        ...
        recordDistrictVisit(districtName) {
            ...
            window.StorageModule.setItem('aquarevier_visited_districts', JSON.stringify([...this.visitedDistricts]));
        ...
        recordStationClick() {
            ...
            window.StorageModule.setItem('aquarevier_clicked_stations', this.clickedStationsCount.toString());
