...
(function () {
    ...
    function translatePopupLabel(deText) {
        const lang = window.AppStorage.getItem('aquarevier_lang') || 'de';
    ...
    window.AQUAREVIER_I18N = {
        dict: I18N_DICT,
        currentLang: () => window.AppStorage.getItem('aquarevier_lang') || 'de',
        translatePopupLabel
    };

    function initLanguageToggle() {
        let currentLang = window.AppStorage.getItem('aquarevier_lang') || 'de';
    ...
    function initAutoThemeSync() {
        if (!window.AppStorage.getItem('theme') && !window.AppStorage.getItem('aquarevier_theme')) {
