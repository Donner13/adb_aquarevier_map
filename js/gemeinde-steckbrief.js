                ...
                <div style="padding: 16px; overflow-y: auto; flex: 1; font-size: 12px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; margin-bottom: 14px;">
                        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 8px; text-align: center;">
                            ...
                            <div style="font-size: 10px; color: var(--text-secondary);">🤝 Akteure</div>
                        </div>
                        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 8px; text-align: center;">
                            <div style="font-size: 18px; font-weight: 700; color: #0284c7;">${dossier.stats.messstellen.length}</div>
                            <div style="font-size: 10px; color: var(--text-secondary);">💧 Messstellen</div>
                        </div>
                        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 8px; text-align: center;">
                            ...
                            <div style="font-size: 10px; color: var(--text-secondary);">🏭 Abwasser/Einleiter</div>
                        </div>
                        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 8px; text-align: center;">
                            ...
                            <div style="font-size: 10px; color: var(--text-secondary);">🌊 Gewässerbauwerke</div>
                        </div>
                    </div>
        ...
        items.forEach(item => {
            html += `
                <div style="padding: 4px 10px; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    ${item.sub ? `<span style="font-size: 10px; color: var(--text-secondary);">${escapeHtml(item.sub)}</span>` : ''}
                </div>
            `;
        });
        html += `</div></div>`;
