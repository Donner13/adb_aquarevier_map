...
(function() {
    ...
    window.openGemeindeDossier = function(gemeindeName) {
        ...
        modal.innerHTML = `
            <div style="background: var(--bg-surface, #ffffff); width: 100%; max-width: 620px; border-radius: 12px; box-shadow: var(--modal-shadow); overflow: hidden; display: flex; flex-direction: column; max-height: 85vh;">
