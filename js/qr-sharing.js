...
(function() {
    ...
    window.openQrShareModal = function() {
        ...
        modal.innerHTML = `
            <div style="background: var(--bg-surface, #ffffff); width: 100%; max-width: 420px; border-radius: 12px; box-shadow: var(--modal-shadow); overflow: hidden; text-align: center; font-size: 12px;">
